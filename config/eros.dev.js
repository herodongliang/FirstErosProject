...
module.exports = {
    ...
    'exports': [
        ...
        // home
        "js/pages/Hello.vue",
        'js/pages/main/mainview.vue',
        'js/pages/main/result.vue',
        'js/pages/refresh/refresh.vue',
        // 'js/pages/main/main.vue',
        //register
        'js/pages/main/ninePic.vue',
        'js/pages/register/register.vue',
